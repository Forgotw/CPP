...
/*   Updated: 2024/01/14 17:27:08 by lsohler          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Harl::complain(std::string level) {
	...
	switch (i) {
		case 0:
			(this->*_debugFunctions[0])();
		case 1:
			(this->*_debugFunctions[1])();
		case 2:
			(this->*_debugFunctions[2])();
		case 3:
			(this->*_debugFunctions[3])();
			break;
		default:
			std::cout << "Harl has nothing to say." << std::endl;
	}
