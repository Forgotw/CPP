...
/*   Updated: 2024/01/23 17:22:11 by lsohler          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Brain::Brain() {
	...
	std::cout << BRAIN DEFCONS << std::endl;
}

Brain::Brain(Brain const &other) {
	*this = other;
	std::cout << BRAIN COPYCONS << std::endl;
}

Brain::~Brain() {
	std::cout << BRAIN DEFDES << std::endl;

}

Brain &Brain::operator=(Brain const &other) {
	std::cout << BRAIN OPECONS << std::endl;
	if (this != &other) {
		*this = other;
	}
	return(*this);
...
void	Brain::resetIdeas(void) {
	for (int i = 0; i < 100; i++) {
		this->ideas[i] = BOLD "My brain is emtpy" RESET;
	}
}
